...
class Model:
    ...
    def buildGraph(self, nMin):
        self._nodi = DAO.getAllANodes(nMin, self._idMap)
    ...
    def _addEdgesV1(self):
        connessioni = DAO.getAllEdgesV1(self._idMap)
    ...
    def _ricorsione(self, parziale, target, t):
        if len(parziale) == (t+1) and parziale[-1]==target:
    ...
    def getObjFun(self, listaNod):
        oFun = 0
        for i in range(0, len(listaNod)-1):
            oFun += self._grafo[listaNod[i]][listaNod[i+1]]["weight"]
